...
import { Smartphone, MessageSquare, Plus } from "lucide-react";
...
const accordionSections = [
  { key: "shop", title: "Shop Categories", links: footerLinks.shop },
  { key: "care", title: "Customer Service", links: footerLinks.customerCare },
  { key: "about", title: "About JAS", links: footerLinks.about },
];
...
export default function Footer() {
    ...
    <>
      ...
      >
        ...
        <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
          <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.02 1.58 4.22.94 1.15 1.94 3.66 2.24v3.85a9.38 9.38 0 0 1-5.13-1.63v7.4c.03 2.1-.63 4.23-1.99 5.8a8.2 8.2 0 0 1-6.19 3.06c-2.3.06-4.63-.74-6.3-2.31A8.99 8.99 0 0 1 .46 16.4c-.06-2.54 1.05-5.07 2.94-6.73 8.87 8.87 0 0 7.23-1.78v3.98a4.92 4.92 0 0 0-3.3 1.83c-1.15 1.16-1.25 2.76-.84 4.19.4 1.34 1.45 2.45 2.8 2.8 1.54.43 3.29-.02 4.3-1.2.66-.75.98-1.75.96-2.75V.02Z" />
        </svg>
      </a>
      <a
  ...
  return (
    <footer className="bg-brand-beige/40 border-t border-brand-border pt-10 pb-6 md:pt-16 md:pb-12 text-brand-charcoal">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="md:hidden">
          ...
          <div className="flex flex-col gap-2.5 pb-4">
            ...
            <p className="font-sans text-xs text-brand-taupe leading-relaxed">
              Curated fashion, beauty and lifestyle essentials for modern living.
            </p>
            ...
            {accordionSections.map((section) => {
              ...
              return (
                <div key={section.key} className="border-b border-brand-border">
                  ...
                  >
                    <span className="font-sans text-[10px] font-bold uppercase tracking-widest text-brand-charcoal">
                      {section.title}
                    </span>
                    <Plus
                      className={`h-4 w-4 text-brand-taupe transition-transform duration-200 ${
                        isOpen ? "rotate-45" : ""
                      }`}
                    />
                  </button>
          ...
          <div className="pt-5 flex flex-col gap-3">
            <div className="flex flex-wrap items-center gap-2">{paymentBadges}</div>
            <div className="flex gap-4 font-sans text-[10px] text-brand-taupe">
            ...
            <p className="font-sans text-[10px] text-brand-taupe">
              © {currentYear} JAS. All rights reserved.
            </p>
          </div>
        </div>
        ...
        <div className="hidden md:block">
          <div className="grid grid-cols-5 gap-y-10 gap-x-6 pb-16 border-b border-brand-border">
            {/* Brand Col */}
            <div className="col-span-2 flex flex-col gap-4">
              ...
              <div className="flex gap-4 mt-2">{socialIcons}</div>
            </div>
